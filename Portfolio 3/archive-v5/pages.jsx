  ...
  return (
    <div className="about">
      ...
      <div className="about__text">
        ...
        <p>I believe a great UX-designer is one who has a real understanding of their user, and the fundamentals and creativity to turn that understanding into a clear solution. That's the bar I try to hold.</p>
